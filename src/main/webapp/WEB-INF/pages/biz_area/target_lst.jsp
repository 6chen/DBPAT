					...
					<form role="form">
						...
						<div class="form-group row">
							<div class="col-xs-6">
								...
								<input id="dbUserNm" class="form-control  input-sm" type="text"
						...
						<div class="form-group row">
							...
							<div class="col-xs-6">
								...
								<input id="dbSchemaNm" class="form-control input-sm" type="text"
					...
					<form role="form">
						...
						<div class="form-group row">
							<div class="col-xs-6">
								...
								<input id="wasUserNm" class="form-control input-sm" type="text"
								       placeholder="User Name"/>
							</div>
							<div class="col-xs-6">
