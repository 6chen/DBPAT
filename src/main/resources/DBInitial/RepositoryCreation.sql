...
INSERT INTO RL VALUES ('RL0001', 'CHECK LOB COLUMN', 'ruleLobColCheck', 'THIS RULE IS USED TO CHECK IF THERE ARE LOB COLUMNS IN THE TABLE', 'RLSET0001');

INSERT INTO RL VALUES ('RL0002', 'CHECK LOB COLUMN2', 'ruleLobColCheck', 'THIS RULE IS USED TO CHECK IF THERE ARE LOB COLUMNS IN THE TABLE', 'RLSET0001');

INSERT INTO RL VALUES ('RL0003', 'CHECK LOB COLUMN3', 'ruleLobColCheck', 'THIS RULE IS USED TO CHECK IF THERE ARE LOB COLUMNS IN THE TABLE', 'RLSET0001');

INSERT INTO RL VALUES ('RL0004', 'CHECK LOB COLUMN3', 'ruleLobColCheck', 'THIS RULE IS USED TO CHECK IF THERE ARE LOB COLUMNS IN THE TABLE', 'RLSET0001');
...
CREATE TABLE JOB_TRGT_HIST(
  JB_ID VARCHAR2(10) NOT NULL,
  BIZ_AREA_ID VARCHAR2(10) NOT NULL,
  TRGT_ID VARCHAR2(10),
  JB_SEQ VARCHAR2(4) ,
  JB_STRT_TM VARCHAR2(20),
  JB_ED_TM VARCHAR2(20),
  DBMS_TYP_ID  VARCHAR2(10),
  SEQ  VARCHAR2(4),
  RL_ID  VARCHAR2(10)
);